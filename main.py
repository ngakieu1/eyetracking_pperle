...
def main(base_path: str, monitor_mm=None, monitor_pixels=None):
    ...
    while True:
        ...
        print(f"Captured: {file_name}, {center}, {time_till_capture}") 
...
if __name__ == '__main__':
    ...
    # when run main file, I need to write this: python -u "/Users/kieuthinga/Downloads/pperle/main.py" --monitor_mm 344,194 --monitor_pixels 1920,1080
